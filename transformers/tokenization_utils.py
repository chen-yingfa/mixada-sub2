...
class PreTrainedTokenizer(PreTrainedTokenizerBase):
    ...
    def _batch_encode_plus(
        ...
        **kwargs
        ...
        # print("tokenization_utils.py:529, input_ids")
        # print(input_ids[:10])
    ...
    def _batch_prepare_for_model(
        ...
        batch_outputs = {}
        # print("tokenization_utils.py:576, batch_ids_pairs")
        # print(batch_ids_pairs)
        for first_ids, second_ids in batch_ids_pairs:
            ...
            # print("tokenization_utils.py:598, outputs")
            # print(outputs)
