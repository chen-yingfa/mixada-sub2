...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    ...
    def __call__(
        ...
        **kwargs
        ...
        # print("tokenization_utils_base.py:2265, text")
        # print(text[:10])
        # print("tokenization_utils_base.py:2265, text_pair")
        # print(text_pair[:10])
    ...
    def prepare_for_model(
        ...
        **kwargs
        ...
        # print("tokenization_utils_base.py:2799", sequence)
        ...
        # print("tokenization_utils_base.py:2826, init BatchEncoding")
